{
  ...
  inputs = {
    ...
    # NB: There is some sorta bug in the fenix stable branch that breaks wasm
    # builds in macos after this commit. Future mitch see if this gets fixed.
    fenix.url = "github:nix-community/fenix/df161b9bd5f8ff444b2c213cd45410b7da6da602";
